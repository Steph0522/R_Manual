...
```{r, echo=FALSE, out.width="300pt", fig.align='center', fig.cap="Se representan los cuatro paneles de Rstudio"}
...
```{r, echo=FALSE,   out.width="50%", fig.cap=" Representación gráfica de como abrir un nuevo script (File > New file > R script). "}
...
```{r, echo=TRUE, out.width= "500pt",echo=FALSE, fig.align='center', fig.cap="Resumen (panel inferior izquierdo) y gráfico boxplot (panel inferior derecho) de la base de datos “Iris”. "}
...
```{r, echo=FALSE, out.width= "400pt", echo=FALSE, fig.align='center', fig.cap="Creación de un nuevo proyecto en R.", out.width="50%"}
knitr::include_graphics(file.path(img_path,"new_directory.png"))
```

```{r, echo=FALSE, out.width= "400pt", echo=FALSE, fig.align='center', fig.cap="Nombrando el nuevo proyecto y escogiendo dónde se guardará.", out.width="50%"}
